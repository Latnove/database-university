...
После добавления данных проверить список коллекций в Qdrant:
...
Проверить информацию о коллекции `demo_collection`:

```bash
http://localhost:6333/collections/demo_collection
```
...
В веб-интерфейсе ввести запрос:
